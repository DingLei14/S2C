...
class SAM_LoRA(nn.Module):
    def __init__(self, num_embed=16):
        ...
        sam = sam_model_registry["vit_b"](checkpoint="/root/autodl-fs/S2C/models/sam_chkpt/sam_vit_b_01ec64.pth")
        self.sam = LoRA_Sam(sam, 8, [8,9,10,11])
    ...
    def run_pretrain(self, image):
        ...
        image_embeddings = self.sam.sam.image_encoder(image)
